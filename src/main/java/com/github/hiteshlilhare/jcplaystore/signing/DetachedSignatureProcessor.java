package com.github.hiteshlilhare.jcplaystore.signing;
...
/**
 * Code is taken from the below mentioned link as it is.
...
public class DetachedSignatureProcessor {
    ...
    public static boolean verifySignature(
        ...
        try (InputStream in = new BufferedInputStream(new FileInputStream(sigFileName)); 
            ...
            logger.info("verifySignature",ex);
            return false;
        }
    }
    ...
    public static void main(
        ...
        //String pubKey = JCConstants.JC_APP_BASE_DIR + "/" + JCConstants.JC_SOURCES_DIR + "/sid062010.signed.pub.key";
        String pubKey = "E:\\Sem-2\\Thesis\\NetBeans\\SwingTest\\sid062010.pub.gpg";
